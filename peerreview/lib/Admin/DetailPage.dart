...
class _DetailPageState extends State<DetailPage> {
  ...
  int calculateTotalTime() {
    Map<String, int> timeInMinutes = {
      '5 min': 500, '10 min': 10, '15 min': 15, '20 min': 20,
      '25 min': 25, '30 min': 30, '35 min': 35, '40 min': 40, '45 min': 45, '50 min': 50
    };
  ...
  Future<void> saveAssignment() async {
    if (explanationController.text.isEmpty || numberOfStudents == 0 || numberOfTasks == 0 || taskTitles.contains('')) {
  ...
  void showTaskTimeModal(int index) {
    List<String> timeOptions = ['5 min', '10 min', '15 min', '20 min', '25 min', '30 min', '35 min', '40 min', '45 min', '50 min'];
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        ...
        child: Column(
          children: [
            Text("Select Task Time", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.black)),
            Expanded(
              child: ListView.builder(
      ...
      style: TextStyle(fontSize: 16),
            ...
            Card(
              ...
              child: ListTile(
                ...
                onTap: () => showNumberSelectionModal((value) => setState(() => numberOfStudents = value), "Select Number of Students"),
              ),
            ),
            SizedBox(height: 10),
            ...
            Card(
              ...
              child: ListTile(
                ...
                trailing: Icon(Icons.arrow_forward),
                onTap: () => showNumberSelectionModal((value) => setState(() => numberOfRanks = value), "Select Number of Ranks"),
              ),
            ),
            SizedBox(height: 10),
                      ...
                      child: Column(
                        ...
                        children: [
                          TextField(
                            ...
                            onChanged: (text) => setState(() => taskTitles[index] = text),
                          ),
                          SizedBox(height: 10),
                          ElevatedButton(
                          ...
                          TextButton(
                            ...
                            child: Text("Remove Task", style: TextStyle(color: Colors.red)),
                          ),
                        ],
                      ),
                    ),
